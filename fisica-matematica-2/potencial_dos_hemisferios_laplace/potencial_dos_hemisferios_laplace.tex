...
\end{equation*}
Por lo tanto, el paso algebraico que conecta ambas expresiones es
\begin{align*}
\int_0^1P_n(x)\dd x
&=-\frac{P_{n+1}(0)-P_{n-1}(0)}{2n+1}\\[0.3em]
&=\frac{P_{n-1}(0)-P_{n+1}(0)}{2n+1}\\[0.3em]
&=\frac{P_{n-1}(0)-\left[-\dfrac{n}{n+1}P_{n-1}(0)\right]}{2n+1}\\[0.3em]
&=\frac{\left(1+\dfrac{n}{n+1}\right)P_{n-1}(0)}{2n+1}\\[0.3em]
&=\frac{\dfrac{2n+1}{n+1}P_{n-1}(0)}{2n+1}\\[0.3em]
&=\frac{P_{n-1}(0)}{n+1}.
\end{align*}
Así,
\begin{equation}
...
\qquad n\ \text{impar}.
\end{equation}
Además, reemplazando explícitamente en la definición de $c_n$, para $n$ impar se obtiene
\begin{align*}
c_n
&=\frac{2n+1}{2}\int_{-1}^{1}f(x)P_n(x)\dd x\\
&=\frac{2n+1}{2}\left(2V_0\int_0^1P_n(x)\dd x\right)\\
&=(2n+1)V_0\frac{P_{n-1}(0)}{n+1}.
\end{align*}
Por otro lado, si $n$ es par, $P_n$ es par, de modo que $f(x)P_n(x)$ es impar y su integral simétrica en $[-1,1]$ se anula. Entonces
\begin{equation}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.78\textwidth]{figures/fig_01_cdb_truncaciones.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.76\textwidth]{figures/fig_02_coeficientes_legendre.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.86\textwidth]{figures/fig_05_esfera_hemisferios.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.70\textwidth]{figures/fig_03_potencial_interior.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.70\textwidth]{figures/fig_04_potencial_exterior.pdf}
